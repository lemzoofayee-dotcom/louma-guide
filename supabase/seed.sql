...
('diwtir-pure', 'Diwtir Pure', 'Diw tir', (SELECT id FROM categories WHERE slug='beurres'), 25.00, 'par 1L', 30.00, 'Huile', 'Huile de palme rouge non raffinee, extraite artisanalement. Couleur rouge-orangee naturelle.', 'Senegal', 'Gout fruite et terreux, couleur rouge vif naturelle. Pur jus, non traite.', 'Entre dans le soupoukandja, le thiou diwtir, le borokhe, le niankatang diola, le fouty et l''etodie. Traditionnellement ajoute a une bouillie de farine de mil pour les jeunes mamans, afin de faciliter la cicatrisation apres l''accouchement.', 'diwtir.webp', NULL, true, 'https://www.seggfaye.com/produits/diwtir-pure.html'),
...
((SELECT id FROM dishes WHERE slug='thieboudienne'), (SELECT id FROM products WHERE slug='diwnior-500'), 'Touche finale (beurre clarifie)', 'Un filet en fin de cuisson', false, 7, 'En fin de cuisson, un filet de diwnior (beurre clarifie) parfume le riz. La couleur rouge vient de la tomate double concentre caramelisee, pas de l''huile de palme.'),
