...
('thieboudienne', 'Thieboudienne', 'Ceebu jen', 'Le plat national du Senegal', '🍛', 'Le thieboudienne est LE plat national senegalais : du riz cuit dans une sauce tomate riche avec du poisson frais, des legumes et des condiments seches (guedj, yeet, netetou) qui lui donnent son gout unique et profond.', 45, 90, '6 personnes', 'Moyen', 'Plat principal',
  ARRAY['1 kg de riz brise','1 poisson entier (1,5 kg)','3 cuilleres de concentre de tomate','200 ml d''huile de palme rouge','2 gros oignons','3 carottes','1 chou blanc','2 aubergines','1 morceau de citrouille','4 gombos','1 manioc','Persil et oignons verts (roff)','Sel, poivre, piment'],
  '[{"step":1,"title":"Preparer la farce (roff)","text":"Mixer persil, oignons verts, ail et piment. Farcir le poisson avec ce melange."},{"step":2,"title":"Saisir le poisson","text":"Dans une grande marmite, chauffer l''huile de palme. Faire dorer le poisson farci des deux cotes. Reserver."},{"step":3,"title":"Preparer la sauce","text":"Dans la meme huile, faire revenir les oignons emincés. Ajouter le concentre de tomate et le faire rotir 90 secondes. Ajouter le guedj, le yeet et le netetou."},{"step":4,"title":"Cuire les legumes","text":"Ajouter l''eau, porter a ebullition. Ajouter les legumes durs en premier (carottes, manioc, chou), puis les plus tendres. Cuire 20 min."},{"step":5,"title":"Cuire le riz","text":"Retirer poisson et legumes. Filtrer le bouillon. Y cuire le riz. Couvrir d''un torchon puis du couvercle pour l''etuvage final."},{"step":6,"title":"Dresser","text":"Disposer le riz en dome, le poisson au centre, les legumes autour. Servir avec le kani (piment) a cote."}]',
...
((SELECT id FROM dishes WHERE slug='thieboudienne'), (SELECT id FROM products WHERE slug='diwtir-pure'), 'Huile de cuisson + couleur', '200 ml', true, 7, 'C''est l''huile de palme rouge qui donne au thieboudienne sa couleur rouge-orangee caracteristique.'),
